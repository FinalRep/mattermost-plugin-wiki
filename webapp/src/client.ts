...
export const doDelete = async <TData = unknown>(url: string, body = {}) => {
    const {data} = await doFetchWithResponse<TData>(url, {
        method: 'DELETE',
        body,
    });
...
export const doPatch = async <TData = unknown>(url: string, body = {}) => {
    const {data} = await doFetchWithResponse<TData>(url, {
        method: 'PATCH',
        body,
    });
...
export const doFetchWithResponse = async <TData = unknown>(url: string, options = {}) => {
